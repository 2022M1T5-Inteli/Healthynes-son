...
func _process(delta):
	...
	if tempo.pontos == 500:
		...
		var cena2 =load("res://Pacman/Itens/Iten2.tscn")
		var iten2 = cena.instance()
		var cena3 =load("res://Pacman/Itens/Iten3.tscn")
		var iten3 = cena.instance()
		var cena4 =load("res://Pacman/Itens/Iten4.tscn")
		var iten4 = cena.instance()
		var cena5 =load("res://Pacman/Itens/Iten5.tscn")
	...
	if tempo.pontos == 1000:
		...
		var cenaCola2 = load("res://Pacman/Itens/Cola2.tscn")
		var cola2 = cenaCola2.instance()
		var cenaCola3 = load("res://Pacman/Itens/Cola3.tscn")
		var cola3 = cenaCola3.instance()
		var cenaCola4 = load("res://Pacman/Itens/Cola4.tscn")
		var cola4 = cenaCola4.instance()
		var cenaCola5 = load("res://Pacman/Itens/Cola5.tscn")
	...
	if tempo.pontos == 1500:
		...
		var cenaVinho2 = load("res://Pacman/Itens/Vinho2.tscn")
		var vinho2 = cenaVinho2.instance()
		var cenaVinho3 = load("res://Pacman/Itens/Vinho3.tscn")
		var vinho3 = cenaVinho3.instance()
		var cenaVinho4 = load("res://Pacman/Itens/Vinho4.tscn")
		var vinho4 = cenaVinho4.instance()
		var cenaVinho5 = load("res://Pacman/Itens/Vinho5.tscn")
